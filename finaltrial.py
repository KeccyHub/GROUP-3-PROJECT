...
def play_video_with_audio(video_path, audio_path):
    ...
    control_frame = tk.Frame(g3, bg="#636363", width=1)
    ...
    sound_btn.grid(row=1, column=4, columnspan=1, padx=40, sticky="ew")
